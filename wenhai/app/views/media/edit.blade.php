...
<div class="page-header">
    <h1><span class="text-light-gray">{{Lang::get("system.edit", array('string' => Lang::get("menu.medium")) )}} </span></h1>
    <div class="pull-right">
        {{ link_to_route('media.index', Lang::get("system.return", array('string' => '')), null, array('class'=>'btn btn-sm btn-primary')) }}
    </div>
</div>

{{ Form::model($medium, array('class' => 'form-horizontal', 'method' => 'PATCH', 'enctype' => 'multipart/form-data', 'files' => true, 'route' => array('media.update', $medium->id))) }}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
      ...
      {{ link_to_route('media.show', Lang::get("system.cancel", array('string'=> '')), $medium->id, array('class' => 'btn btn-default')) }}
    </div>
</div>
