...
<div class="page-header">
    <h1><span class="text-light-gray">{{Lang::get("system.edit", array('string' => Lang::get("system.settings")) )}} </span></h1>
</div>

{{ Form::model($setting, array('class' => 'form-horizontal', 'method' => 'PATCH', 'enctype' => 'multipart/form-data', 'files' => true, 'route' => array('settings.update', $setting->id))) }}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
              {{ Form::text('favicon', Input::old('favicon'), array('class'=>'form-control', 'placeholder'=>'Favicon')) }}
            </div>
        </div>
