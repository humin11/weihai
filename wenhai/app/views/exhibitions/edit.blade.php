...
<div class="page-header">
    <h1><span class="text-light-gray">{{Lang::get("system.edit", array('string' => Lang::get("menu.exhibition")) )}} </span></h1>
    <div class="pull-right">
        {{ link_to_route('exhibitions.index', Lang::get("system.return", array('string' => '')), null, array('class'=>'btn btn-sm btn-primary')) }}
    </div>
</div>

{{ Form::model($exhibition, array('class' => 'form-horizontal', 'method' => 'PATCH','enctype' => 'multipart/form-data', 'files' => true, 'route' => array('exhibitions.update', $exhibition->id))) }}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
              {{ Form::file('cover', Input::old('cover'), array('class'=>'form-control','data-rule-required'=>true, 'placeholder'=>'Cover')) }}
            </div>
        </div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
      ...
      {{ link_to_route('exhibitions.show', Lang::get("system.cancel", array('string'=> '')), $exhibition->id, array('class' => 'btn btn-default')) }}
    </div>
</div>
